#!/bin/bash
# Script to add category sections to Index.tsx

# This script adds the "Browse by Category" section after line 599 in Index.tsx
# Run this in your repo root: bash add-category-section.sh

FILE="src/pages/Index.tsx"
TEMP_FILE="src/pages/Index.tsx.tmp"
LINE_NUMBER=599
...
# Insert the section after line 599
...
echo "✅ Category section added to Index.tsx after line $LINE_NUMBER"
