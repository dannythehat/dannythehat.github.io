#!/usr/bin/env python3
"""
This script downloads holidays.json, adds 10 new destinations, and outputs the result.
Run this locally to generate the updated file.
"""

import json
import urllib.request

# Download current holidays.json
print("Downloading current holidays.json...")
url = "https://raw.githubusercontent.com/dannythehat/beyond-ordinary-adventures/main/src/data/holidays.json"
with urllib.request.urlopen(url) as response:
    current_holidays = json.loads(response.read().decode())

print(f"Current destinations: {len(current_holidays)}")

# All 10 new destinations
new_destinations = [
    {
...
print(f"New total: {len(all_holidays)} destinations")
...
print("\n✅ File created: UPDATED_holidays.json")
print("Copy this file to src/data/holidays.json")
